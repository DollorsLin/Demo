...
public class JSONUtils {
	...
	public final static String[] requestP033bodyList={"queryId","orderno","cod","payway","banktrace","postrace","tracetime","cardid","signflag","signer","dssn","dsname","cardtype","ums_order_no","target_order_no"};
