...
public class CommandController {
    ...
    @RequestMapping(value = "/findCommandByProductId", method = POST)
    @ApiOperation(value = "根据productId查找", notes = "根据productId查找")
    public Command findCommandByProductId(@RequestParam(value = "productId") Integer productId){
        return commandService.findCommandByProductId(productId);
    }
